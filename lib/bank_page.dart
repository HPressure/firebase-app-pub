...
class BankPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => BankPageState();
}
...
class _FieldsSectionState extends State<_FieldsSection> {
  ...
  Future<void> _submitRequest() async {
    ...
    /*DocumentReference _reference = Firestore.instance
        .collection("Заявки")
        .document("Оргтенхика")
        .collection(bankequipmentString)
        .document(_docName);*/
    String _reference = 'Заявки/Оргтехника/'+bankequipmentString;
    ...
    _requestData["Вид заявки"] = bankequipmentString;
    ...
    Message message = new Message()
      ..subject = 'Заявка: $bankequipmentString'
      ..html = '<h1>Заявка: $bankequipmentString</h1>'+
