...
class KkmPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => KkmPageState();
}

class KkmPageState extends State<KkmPage> {
  @override
  void initState() {
    super.initState();
  }
...
class _FieldsSectionState extends State<_FieldsSection> {
  ...
  Future<void> _submitRequest() async {
    ...
    String _reference = 'Заявки/Кассы/'+cashregisterString;
    ...
    _requestData["Вид заявки"] = cashregisterString;
    ...
    Message message = new Message()
      ..subject = 'Заявка: $cashregisterString'
      ..html = '<h1>Заявка: $cashregisterString</h1>'+
